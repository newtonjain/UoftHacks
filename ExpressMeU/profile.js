...
var profileForm = forms.create({
  ...
  interests: forms.fields.string(),
  phrases: forms.fields.array()
...
function renderForm(req,res,locals){
  res.render('profile', extend({
    ...
    phrases: req.user.customData.phrases,
    interests: req.user.customData.interests
  ...
  router.all('/', stormpath.loginRequired, function(req, res) {
    profileForm.handle(req,{
      success: function(form){
        ...
        req.user.customData.phrases = form.data.phrases;
        req.user.customData.interests = form.data.interests;
